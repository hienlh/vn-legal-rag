...
Full 3-Tier (with Tier 3 RRF) & \textbf{76.5} \\
\bottomrule
\end{tabular}
\normalsize
\justifying
...
Each tier provides additive improvement: Tier~1 alone achieves 56.2\%, adding Tier~2 brings 71.2\% (+15.0pp), and Tier~3 fusion adds another 5.3pp to reach 76.5\%.
