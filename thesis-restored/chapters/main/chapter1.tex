...
\begin{itemize}
    \item \textbf{Chương~2: Cơ sở lý thuyết và các công trình liên quan}: trình bày các phương pháp truy xuất thông tin (truy xuất thưa, truy xuất dày đặc, đồ thị tri thức, ontology, Retrieval-Augmented Generation) và khảo sát các phương pháp truy vấn kiến thức pháp lý liên quan.
