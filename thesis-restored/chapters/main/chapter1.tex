...
\begin{enumerate}
    \item Xây dựng Knowledge Graph và Ontology cho văn bản quy phạm.
    \item Đề xuất kiến trúc truy xuất 3-Tier KG-RAG.
    \item Xây dựng bộ đánh giá và so sánh định lượng.
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Chương~\ref{chap:chapter2}}: Thu thập kiến thức về quy định đào tạo.
    \item \textbf{Chương~\ref{chap:chapter3}}: Thiết kế giải thuật.
    \item \textbf{Chương~\ref{chap:chapter4}}: Thiết kế hệ thống và thử nghiệm.
    \item \textbf{Chương~\ref{chap:chapter5}}: Kết luận và hướng phát triển.
\end{itemize}
